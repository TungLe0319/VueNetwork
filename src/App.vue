<template>
  ...
  <main class="container-fluid">
    <div class="row">
      <div
        class="col-md-2 bg-dark text-light sideNav rounded-end elevation-2 border border-secondary border-1 profile-Banner d-none d-md-block"
      >
        <div class="mt-3">
          <Login />
        </div>
      ...
      >
        <div class="modal-dialog modal-dialog-centered modal-xl">
          <div class="modal-content">
            <div
              class="modal-body modal1 elevation-5"
...
.modal1 {
  ...
  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(176, 221, 233, 0.615);
}
